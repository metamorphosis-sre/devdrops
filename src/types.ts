export interface Env {
  ...
  AMADEUS_API_KEY: string;          // Amadeus flight search
  AMADEUS_API_SECRET: string;       // Amadeus flight search
  ADZUNA_APP_ID: string;            // Adzuna job search
  ADZUNA_API_KEY: string;           // Adzuna job search
